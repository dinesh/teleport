...
- **Open Standards**: There is no security through obscurity. Teleport is fully
  ...
  [OpenSSH]((../server-access/guides/openssh.mdx#using-openssh-client).
...
- [OpenSSH: `ssh`]((../server-access/guides/openssh.mdx#using-openssh-client) (works on Linux, macOS and Windows)
