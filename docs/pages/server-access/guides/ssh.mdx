---
title: How to Use Teleport with SSH
description: How to use Teleport with SSH
---
...
This Guide describes common scenarios one is likely to encounter when using Teleport in such a way.
...
4. You should now be able to view both Nodes in the Teleport Web Interface after logging in with your user.
